...
public class PartidaHub : Hub
{
    ...
    public async Task GetJogadoresStatus(string roomName)
    {
        ...
        if (dictionary.ContainsKey(roomName))
        {
            string[] jogadorInfo1 = { "Zé da Manga", dictionary[roomName][0].forca.ToString(), dictionary[roomName][0].vida.ToString() };
            string[] jogadorInfo2 = { "Hide on Bush", dictionary[roomName][1].forca.ToString(), dictionary[roomName][1].vida.ToString() };
