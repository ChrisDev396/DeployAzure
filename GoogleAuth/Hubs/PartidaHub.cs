...
public class PartidaHub : Hub
{
    ...
    public async Task GetJogadoresStatus(string roomName)
    {
        ...
        if (dictionary.ContainsKey(roomName))
        {
            ...
            await Clients.Group(roomName).SendAsync("GetJogadoresStatus", dictionary[roomName][0].nome, dictionary[roomName][0].forca.ToString(), dictionary[roomName][0].vida.ToString(), dictionary[roomName][0].heroi, dictionary[roomName][0].turno.ToString());
        }
        else
        {
